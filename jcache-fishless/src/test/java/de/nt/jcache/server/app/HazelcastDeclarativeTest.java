 ...
 * @author paoli
 */
public class HazelcastDeclarativeTest {
    public static void main(String[] args) {
        System.setProperty("hazelcast.config", "classpath:hazelcast.xml");
        System.setProperty("hazelcast.jcache.provider.type", "server");

        CachingProvider cachingProvider = Caching.getCachingProvider("com.hazelcast.cache.impl.HazelcastServerCachingProvider");
        ...
        ICache<Object, Object> cache = cacheManager.getCache("guestCharges").unwrap(ICache.class);
